...
if rev in (21,25,29,33,39,40,41,42,43):
 ...
 if rev>=40:stage['routes'].sort(key=lambda item:0 if item[0].startswith(f'v{rev}:') else 1)
...
if rev>=34:
 ...
 if rev>=35:
  ...
  if rev<40:
   ...
   assert actual==([(74,8),(74,44),(92,8),(92,44)] if rev==40 else ([(74,8),(92,8),(110,8),(128,8)] if rev==41 else [(22,-31),(40,-31),(58,-31),(76,-31)])),actual
   def world_size(o):
   ...
   if rev==41:
    ...
    assert abs(wall.matrix_world.translation.y-8)<.01
