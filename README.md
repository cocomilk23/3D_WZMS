...
已制作南大门样板，以及向校内连续延伸的三个外景初版：南大门广场、德涵楼与贯真楼外景、中山路南段及跨水桥。全校园尚未建成，各版待用户验收。
...
- [v0.0.6中山路南段与跨水桥](deliverables/v0.0.6/交付说明.md) · **[最新整合Blender工程](models/campus/WZMS_Campus_v006.blend)**
- [Blender样板模型](models/south_gate/WZMS_SouthGate_v002.blend)（Git LFS，含打包的墙面参考图）

![南侧三个场景初版](deliverables/v0.0.6/previews/17_Three_scenes_overview.png)
...
最新路线见[从南大门向北的制作顺序](docs/南北向制作顺序.md)。本轮三个场景初版已制作；下一场景是步青广场。每完成一个场景独立提交、推送并建立版本标签，不再更新网页预览。三场景的照片依据及估算边界见[建模依据](docs/南侧三场景建模依据.md)。
