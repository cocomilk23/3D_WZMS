...
groups=[('buqing',['03_buqing_wide']),('cultural',['08_math','09_history']),('taohua',['11_taohua'])]
...
out=m/'WZMS_Anthem_Clean_v2_1080p.mp4';assert not out.exists(),'Preserve prior deliverables'
